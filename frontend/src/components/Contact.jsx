...
// ✅ Uses same env variable as AIAgent
...
const Contact = () => {
  ...
  // ✅ Fixed: Only one handleSubmit — actually calls the backend
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-16 md:gap-8 items-center justify-between">
        ...
        <div ref={leftRef} className="flex-1 w-full flex flex-col justify-center">
          ...
          <div className="flex gap-6 items-center">
            <a href="https://www.linkedin.com/in/ayush-raj-tiwary-3b4392227" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 group">
            ...
            <a href="https://github.com/ARTiwary" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 group">
            ...
            <a href="mailto:ayushrajtiwary07@gmail.com" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 group">
            ...
            <form ref={formRef} className="flex flex-col gap-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <input 
                    type="text" id="email" value={formData.email} onChange={handleChange}
