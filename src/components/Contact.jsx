      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-16 md:gap-8 items-center justify-between">
        ...
        <div ref={leftRef} className="flex-1 w-full flex flex-col justify-center">
          ...
          <div className="flex gap-6 items-center">
            {/* LinkedIn */}
            <a href="#" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 group">
            ...
            {/* Instagram / Mail */}
            <a href="mailto:hello@example.com" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 group">
